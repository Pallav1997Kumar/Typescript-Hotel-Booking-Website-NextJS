...
import { SingleDateEventBookingDetailsInterface } from "@/interface/Event Meeting Interface/eventMeetingBookingInterface";
...
async function POST(request: NextRequest){
    try {
        const body: SingleDateEventBookingDetailsInterface = await request.json();
        const bookingDetails: SingleDateEventBookingDetailsInterface = body;
