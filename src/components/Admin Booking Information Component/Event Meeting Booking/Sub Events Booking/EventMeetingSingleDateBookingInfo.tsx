...
import { ISingleDateBookingInfoForAdmin } from '@/interface/Event Meeting Interface/viewEventMeetingBookingApiResponse';
...
interface IPropsEventMeetingSingleDateBookingInfo {
    eachEventMeetingBookingInfo: ISingleDateBookingInfoForAdmin;
}


function EventMeetingSingleDateBookingInfo(props: IPropsEventMeetingSingleDateBookingInfo){

    const eachEventMeetingBookingInfo: ISingleDateBookingInfoForAdmin = props.eachEventMeetingBookingInfo;

    const transactionDetails: ITransactionDetailsFrontend = eachEventMeetingBookingInfo.transactionDetails;
    const customerDetails: IHotelCustomersDetailsFrontend = eachEventMeetingBookingInfo.customerDetails;
