...
interface IPropsPriceDetailsEachDate {
    bookingDetailsForCart: NonContinuousMultipleDatesBookingDetailsWithDateNumberInterface | null;
    setTotalPriceOfRoom: (totalPriceOfAllRooms: number) => void;
}


function PriceDetailsEachDate(props: IPropsPriceDetailsEachDate) {
    ...
    const bookingDetails: NonContinuousMultipleDatesBookingDetailsWithDateNumberInterface | null = props.bookingDetailsForCart;
    ...
    function getSpecificMealFoodServiceTotalPricePerGuest(
        ...
        const currentTimeFoodDetails: EventTimingDetailsForFoodPrice | undefined = 
            foodServicePriceInformation.eventTimingDetails.find(function(eachFoodTime: EventTimingDetailsForFoodPrice){
                    ...
                    <TableBody>
                        ...
                        <TableRow>
                            <TableCell>
                                {
                                    getDateText(
                                        typeof bookingDetails.meetingEventBookingDate === 'string' 
                                        ? new Date(bookingDetails.meetingEventBookingDate) 
                                        : bookingDetails.meetingEventBookingDate)
                                }
                            </TableCell>
                        ...
                        <TableRow>
                            <TableCell>
                                {getDateText(typeof bookingDetails.meetingEventBookingDate === 'string' ? new Date(bookingDetails.meetingEventBookingDate) : bookingDetails.meetingEventBookingDate)}
                            </TableCell>
