...
interface IPropsEventMeetingSingleDateBookingInfo {
    eachEventMeetingBookingInfo: IEventMeetingRoomSingleDateCartInformation;
}


function EventMeetingSingleDateBookingInfo(props: IPropsEventMeetingSingleDateBookingInfo){

    const eachEventMeetingBookingInfo: IEventMeetingRoomSingleDateCartInformation = props.eachEventMeetingBookingInfo;
