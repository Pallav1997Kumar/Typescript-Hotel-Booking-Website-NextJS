...
import { IContinousMultipleDatesBookingInfoForCustomer } from '@/interface/Event Meeting Interface/viewEventMeetingBookingApiResponse';
...
interface IPropsEventMeetingMultipleDateContinuousBookingInfo {
    eachEventMeetingBookingInfo: IContinousMultipleDatesBookingInfoForCustomer;
