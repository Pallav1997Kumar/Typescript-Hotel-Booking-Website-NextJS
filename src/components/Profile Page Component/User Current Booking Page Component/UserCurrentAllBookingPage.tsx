...
function UserCurrentAllBookingPageFunctionalComponent(){
    ...
    async function fetchRoomSuiteBookingDb(loginUserId: string) {
        try {
            const response: Response = await fetch(
                `/api/view-current-booking/rooms-suites/${loginUserId}`
            );
    ...
    return (
        <React.Fragment>
            ...
            <div className="m-8">
                <h2 className="text-center text-2xl font-bold mb-4">MY CURRENT BOOKINGS</h2>
                    ...
                    {(!loadingBookingDetails &&
                        ...
                        <div className="flex flex-col items-center justify-center bg-[antiquewhite] py-20">
                            <p className="uppercase font-extrabold font-sans text-2xl p-2 leading-[200%] tracking-wide underline">
                                You do not have any Current or Future Upcoming Bookings
                            </p>
                        </div>
                    }
...
export default UserCurrentAllBookingPage;