...
import { MultipleContinuousDatesBookingDetailsWithPriceInterface } from '@/interface/Event Meeting Interface/eventMeetingBookingInterface';
...
interface IPropsEventMeetingMultipleDateContinuousCartComponent{
    eachEventMeetingInCart: MultipleContinuousDatesBookingDetailsWithPriceInterface;
}
