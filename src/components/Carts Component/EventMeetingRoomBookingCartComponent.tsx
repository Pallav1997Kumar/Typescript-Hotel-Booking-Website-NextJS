    ...
    return (
        <div className="border border-black m-2">
            {(allEventMeetingBookingCart.length > 0) && 
                allEventMeetingBookingCart.map(function(
                    ...
                    return (
                        <div 
                            key={eachEventMeetingInCart.eventCartId} 
                            className="flex flex-row p-4 m-4 border-4 border-gray-500"
                        >
                            ...
                            <div className="w-3/5 pl-4">
                                {(eachEventMeetingInCart.roomBookingDateType == roomBookingDateTypeConstants.SINGLE_DATE) &&
                                    <EventMeetingSingleDateCartComponent 
                                        eachEventMeetingInCart={eachEventMeetingInCart as SingleDateEventBookingDetailsWithPriceInterface} 
                                    />
                                }

                                {(eachEventMeetingInCart.roomBookingDateType == roomBookingDateTypeConstants.MULTIPLE_DATES_CONTINOUS) &&
                                    <EventMeetingMultipleDateContinuousCartComponent 
                                        eachEventMeetingInCart={eachEventMeetingInCart as MultipleContinuousDatesBookingDetailsWithPriceInterface} 
                                    />
                                }
                                {(eachEventMeetingInCart.roomBookingDateType == roomBookingDateTypeConstants.MULTIPLE_DATES_NON_CONTINOUS) &&
                                    <EventMeetingMultipleDateNonContinuousCartComponent 
                                        eachEventMeetingInCart={eachEventMeetingInCart as NonContinuousMultipleDatesBookingDetailsInterface} 
                                    />
                                }
                            </div>
                        </div>
