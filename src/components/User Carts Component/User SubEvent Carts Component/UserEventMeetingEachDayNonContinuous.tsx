...
interface IPropsUserEventMeetingEachDayNonContinuous {
    eachBookingDate: IDateBooking;
}


function UserEventMeetingEachDayNonContinuous(props: IPropsUserEventMeetingEachDayNonContinuous){
