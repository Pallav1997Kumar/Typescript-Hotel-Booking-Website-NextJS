...
interface IPropsUserEventMeetingFoodServices {
    eachEventMeetingInCart: IEventMeetingRoomContinousMultipleDatesCartInformation | IEventMeetingRoomSingleDateCartInformation;
}


function UserEventMeetingFoodServices(props: IPropsUserEventMeetingFoodServices){
    const eachEventMeetingInCart: IEventMeetingRoomContinousMultipleDatesCartInformation | IEventMeetingRoomSingleDateCartInformation = props.eachEventMeetingInCart;

    const meetingEventBookingTime: ("Morning" | "Afternoon" | "Evening" | "Night" | "Mid Night")[] = eachEventMeetingInCart.meetingEventBookingTime;
    ...
    const mealsObj = eachEventMeetingInCart.selectedMealsOnBookingDate;
