...
interface IPropsUserEventMeetingMultipleDateContinuousCart {
    eachEventMeetingInCart: IEventMeetingRoomContinousMultipleDatesCartInformation;
    onRemoveEventMeetingItemFromCart: (id: string, bookingType: string) => void;
}


function UserEventMeetingMultipleDateContinuousCart(props: IPropsUserEventMeetingMultipleDateContinuousCart){
    
    const eachEventMeetingInCart: IEventMeetingRoomContinousMultipleDatesCartInformation = props.eachEventMeetingInCart;
    const [viewFoodItems, setViewFoodItems] = useState<boolean>(false);


    async function removeEventMeetingMultipleDatesContinuousItemFromCart(id: string, bookingType: string){
    ...
    return (
        <div className="w-[100%] p-0">
            ...
            <p className="font-[Lucida_Sans] mb-2 capitalize">
                <span className="font-semibold">Meeting / Event Start Booking Date: </span>
                {getDateTextFromFullDate(eachEventMeetingInCart.meetingEventStartBookingDate.toString())}
            </p>
            
            <p className="font-[Lucida_Sans] mb-2 capitalize">
                <span className="font-semibold">Meeting / Event End Booking Date: </span>
                {getDateTextFromFullDate(eachEventMeetingInCart.meetingEventEndBookingDate.toString())}
            </p>
            ...
            <div className="flex flex-row justify-center items-center mr-4 space-x-4">
