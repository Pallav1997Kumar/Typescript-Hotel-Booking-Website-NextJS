...
import { IDiningBookingInfo, ITableBookingCountDetails } from "@/interface/Dining Interface/diningDatabaseModelsInterface";
...
const diningBookingInfoSchema = new Schema<IDiningBookingInfo>({
    customerId: {
...
const DiningBookingInfo: Model<IDiningBookingInfo> = mongoose.models.DININGBOOKINGINFO || mongoose.model<IDiningBookingInfo>('DININGBOOKINGINFO', diningBookingInfoSchema);
